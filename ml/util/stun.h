 ...
 */
int send_stun_request(const int udpSocket,struct sockaddr_storage *stunServ);
 ...
 * @return 0 if successful
 */
int send_stun_keep_alive(const int udpSocket,struct sockaddr_storage *stunServ);
